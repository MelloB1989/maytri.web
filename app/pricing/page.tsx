...
export default function Pricing() {
  return (
    <>
      <Header />
      <section className="py-12 bg-gray-950 sm:py-16 lg:py-20">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="flex items-center justify-center">
              <div className="inline-flex items-center justify-center text-lg bg-pink-400 rounded-full w-9 h-9">
                ❤️
              </div>
              <h2 className="ml-3 text-4xl font-bold text-gray-50 font-pj">
                Get a Maytri
              </h2>
            </div>
            <p className="mt-4 text-base font-medium text-gray-400 font-pj">
              A Maytri is a friend who is always there for you
            </p>
          </div>
                  ...
                  <div className="md:col-span-3 xl:pr-2 space-y-9">
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="mt-1 text-sm font-normal text-gray-600 font-pj">
                          Meaningful and supportive chats.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center">
          ...
          <div className="mt-8 text-center">
            <p className="text-base font-medium text-gray-100 font-pj">
              All our features are available to all users
            </p>
            <div className="flex items-end justify-center mt-10">
              <p className="text-lg font-bold text-gray-50 font-pj">₹</p>
              <p className="text-6xl font-bold text-gray-50 font-pj">99</p>
              <p className="text-lg font-bold text-gray-100 font-pj">/month</p>
            </div>
            <a
              href="#"
              title=""
              className="relative inline-flex items-center justify-center px-8 py-3.5 text-base font-bold text-white transition-all duration-200 bg-pink-600 border border-transparent mt-9 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 font-pj hover:bg-opacity-90 rounded-xl"
              role="button"
            >
              Get started for ₹99 only
            </a>
            <p className="mt-4 text-sm font-normal text-gray-600 font-pj">
              Make Maytri yours now.
            </p>
          </div>
        </div>
      </section>
